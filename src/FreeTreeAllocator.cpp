...
cpp_custom::FreeTreeAllocator::FreeTreeAllocator(const std::size_t size)
	: Allocator(size)
{
...
cpp_custom::FreeTreeAllocator::~FreeTreeAllocator()
{
	::operator delete(m_StartAddress);
	m_StartAddress = nullptr;
}

void* cpp_custom::FreeTreeAllocator::Allocate(const std::size_t size, const std::size_t alignment)
{
...
void cpp_custom::FreeTreeAllocator::Deallocate(void* ptr)
{
...
void cpp_custom::FreeTreeAllocator::Reset()
{
	Init();
}

void cpp_custom::FreeTreeAllocator::Init()
{
...
void cpp_custom::FreeTreeAllocator::Coalescence(RBTree::Node* curr)
{
...
std::size_t cpp_custom::FreeTreeAllocator::GetRootNodePadding()
{
