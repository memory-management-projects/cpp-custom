...
void cpp_custom::RBTree::Init(Node* nil)
{
	m_Nil = nil;
...
cpp_custom::RBTree::Node* A5::RBTree::Search(const std::size_t v)
{
	Node* x = m_Root;
	while (x != m_Nil)
	{
...
cpp_custom::RBTree::Node* A5::RBTree::SearchBest(const std::size_t v)
{
	Node* y = nullptr;
	Node* x = m_Root;
	while (x != m_Nil)
...
cpp_custom::RBTree::Node* A5::RBTree::SearchAtLeast(const std::size_t v)
{
	Node* x = m_Root;
	while (x != m_Nil)
	{
...
void cpp_custom::RBTree::Insert(Node* z)
{
	Node* y = nullptr;
	Node* x = m_Root;
	while (x != m_Nil)
...
void cpp_custom::RBTree::InsertFixup(Node* z)
{
...
void cpp_custom::RBTree::Remove(Node* z)
{
	Node* x = nullptr;
	Node* y = z;
...
void cpp_custom::RBTree::RemoveFixup(Node* z)
{
...
cpp_custom::RBTree::Node* A5::RBTree::Successor(Node* x)
{
	x = x->m_Right;
...
void cpp_custom::RBTree::Print() const
{
...
void cpp_custom::RBTree::Print(Node* x, bool isRight, std::string indent) const
{
	if (x->m_Right != m_Nil) {
...
void cpp_custom::RBTree::Transplant(Node* u, Node* v)
{
...
void cpp_custom::RBTree::LeftRotate(Node* x)
{
...
void cpp_custom::RBTree::RightRotate(Node* x)
{
	Node* xParent = x->GetParent();
	Node* y = x->m_Left;
	x->m_Left = y->m_Right;
