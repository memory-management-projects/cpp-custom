...
cpp_custom::BuddyAllocator::BuddyAllocator(const std::size_t size)
	: Allocator(size)
{
...
cpp_custom::BuddyAllocator::~BuddyAllocator()
{
	::operator delete(m_StartAddress);
	m_StartAddress = nullptr;
}

void* cpp_custom::BuddyAllocator::Allocate(const std::size_t size, const std::size_t alignment)
{
...
void cpp_custom::BuddyAllocator::Deallocate(void* ptr)
{
...
void cpp_custom::BuddyAllocator::Reset()
{
...
void cpp_custom::BuddyAllocator::Init()
{
